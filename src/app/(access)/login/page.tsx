export default function LoginPage() {
  return (
    <div className="flex">
      <div className="flex w-lg h-screen bg-gradient-to-bl from-red-950 to-yellow-600 flex-none text-black">
      ...
      <div className="w-full flex-1 text-black shadow-xl/30 ">02</div>
    </div>
  );
}
